...
class ProductoService {
  ...
  final String _BUSCAR_PRODUCTO = '/buscar';
...
Future<List<ProductoConUsuarioModel>> busquedaProductos(String nombre, String token) async {
  final response = await http.get(
    Uri.parse('$URL$_OBTENER_PRODUCTO$_BUSCAR_PRODUCTO?nombre=$nombre'),
    headers: {
      'Authorization': 'Bearer $token',
      "Access-Control-Allow-Origin": "*",
      'Accept': 'application/json', 
